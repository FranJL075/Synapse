    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad', models.CharField(max_length=100)),
                ('precio', models.IntegerField(default=0)),
                ('id_ingreso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.ingreso')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.CharField(max_length=300)),
                ('estado', models.CharField(max_length=20)),
                ('codigo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.articulo')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.detalle_ingreso'),
        ),
    ]
